...
- [ ] Add more patient scenarios (oncology, durable medical equipment, home health)
- [ ] Add a "sandbox mode" with editable denial rates
- [ ] Add leaderboard / high-score tracking (in-session only)
- [ ] Add accessibility improvements (keyboard drag-and-drop)
- [ ] Add print-friendly workflow summary
